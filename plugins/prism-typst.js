 ...
 * Vendored from https://github.com/Mc-Zen/prism-typst (MIT License, © Mc-Zen).
 * Local modification: prepended `import Prism from "prismjs"` so it registers
 * on the same Prism instance used by @11ty/eleventy-plugin-syntaxhighlight.
 */
